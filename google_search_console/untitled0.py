...
print(get_domain_name("https://medtigo.com/"))
print("\n")
print("All working till Creating_Directory Part")
print('\n')
...
print("\nAll is well upto the API level")
...
site = "https://medtigo.com"    # Property to extract
num_days =  60                    # Number of Days, Months to Extract
